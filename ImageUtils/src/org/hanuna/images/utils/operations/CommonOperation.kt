...
fun <T> RingOperation<T>.matrixSimpleTimes(a: Matrix<T>, b: Matrix<T>): ImageMatrix<T> = matrixElementOperation(a, b, times)

fun <T> RingOperation<T>.matrixTimes(a: Matrix<T>, b: Matrix<T>): ImageMatrix<T> = matrixMultiplyOperation(a, b, times, plus)